...
const pages = [
  {
    ...
    style: {
      navigationBarTitleText: "健身数据"
    }
  },
  {
    path: "pages/limb/limb",
    style: {
      navigationBarTitleText: "四肢锻炼数据（周二/周五）"
    }
  },
  {
    path: "pages/trunk/trunk",
    style: {
      navigationBarTitleText: "躯干锻炼数据（周一/周四）"
    }
  }
];
const globalStyle = {
...
const S = true, b = "mp-weixin", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), C = b, P = I('{\n    "address": [\n        "127.0.0.1",\n        "192.168.81.164"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/iCloudDrive/HBuilderX.4.29.2024093009/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), T = I('[{"provider":"aliyun","spaceName":"wxnotion","spaceId":"mp-2f231651-b257-4883-b30c-a38cc8ef660c","clientSecret":"l5+QdVfTC5Ofz7q/TBfpWA==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__DB20B0B";
} catch (e2) {
